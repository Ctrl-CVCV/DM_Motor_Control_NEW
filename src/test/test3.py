    ...
    try:
        while True:
            ...
            if target_center is not None:
                ...
                # 画出规划好的轨迹点
                for pt in circle_points: cv2.circle(display_frame, pt, 2, (255, 255, 0), -1)
                ...
                cv2.circle(display_frame, (target_px, target_py), 6, (0, 0, 255), -1)
                cv2.line(display_frame, (center_x, center_y), (target_px, target_py), (0, 255, 255), 2)
                
                cv2.putText(display_frame, f"MODE: 2 (CIRCLE SMOOTH)", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
                cv2.putText(display_frame, f"TX -> dx:{dx_comp:.2f}, dy:{dy_comp:.2f} (COMP)", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 165, 255), 2)
                cv2.putText(display_frame, f"POINT: {current_point_idx+1}/50", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
                ...
                cv2.putText(display_frame, f"MODE: 2 (PAUSED) - WAIT TARGET", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                cv2.putText(display_frame, f"POINT: {current_point_idx+1}/50 (HOLDING)", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 165, 255), 2)
            
            if mcu.ser is None:
                cv2.putText(display_frame, "MCU: DISCONNECTED", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            elif mcu.is_mcu_alive():
                cv2.putText(display_frame, f"MCU [{mcu.port}]: ONLINE", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)

            cv2.imshow("Circle Edge Tracer", display_frame)
